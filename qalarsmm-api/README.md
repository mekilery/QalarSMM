 ![qalarsmm API](http://i.imgur.com/aKbFCOy.png "Your Open-source Social Media Dashboard")
==========
qalarsmm Api's is created with Node.js, Express, MongoDB and Sequelize ORM. qalarsmm Api are classified to four micro services. They are namely 
...
```code
set NODE_ENV=development & cd ./qalarsmm-api/User & pm2 start ./qalarsmm-api/User/user.server.js & cd ../Feeds & pm2 start ./qalarsmm-api/Feeds/feeds.server.js & cd ../Publish & pm2 start ./qalarsmm-api/Publish/publish.server.js & cd ../Notification & pm2 start ./qalarsmm-api/Notification/notify.server.js & cd ../Update & pm2 start ./qalarsmm-api/Update/update.server.js & pm2 status
```
