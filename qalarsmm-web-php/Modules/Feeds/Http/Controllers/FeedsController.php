...
class FeedsController extends Controller
{
     ...
     * This function is used for liking  the particular feed of twitter account from qalarsmm by hitting API.
     ...
     * This function is used for liking  the particular feed of youtube channel account from qalarsmm by hitting API.
     ...
     * This function is used for disLiking  the particular feed of youtube channel account from qalarsmm by hitting API.
     * @param {integer} videoId - video ID of feed.
     * @param {integer} accounId- account id of that particular youtube account.
     ...
     * * This function is used for comment on  the particular feed of youtube channel account from qalarsmm by hitting API.
     * @param {integer} videoId - video ID of feed.
     * @param {integer} accounId- account id of that particular youtube account.
     ...
     * This function is used for liking on  the particular feed of facebook website account from qalarsmm by hitting API.
     ...
     * This function is used for comment on  the particular feed post  of Facebook page account from qalarsmm by hitting API.
