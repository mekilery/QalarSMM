...
class DashboardController extends Controller
{
    ...
    /**
     * TODO we've to display all social accounts added in qalarsmm in accounts page.
     * This function is used for displaying the  all social accounts added in qalarsmm in accounts page.
    ...
    /**
     * TODO we've to add Social accounts from dashboard page to qalarsmm and display.
     * This function is adding social accounts from front end and display in qalarsmm site(facebook,network,youtube).
     * @return  accounts page view blade with all data required to display from controller to view.
     */
    ...
    /**
     * TODO we've to add Twitter accounts from dashboard page to qalarsmm and display.
     * This function is adding twitter accounts from front end and hit API to store in qalarsmm database.
    ...
    /**
     * TODO we've to add Faceboook accounts from dashboard page to qalarsmm and display.
     * This function is adding Faceboook accounts from front end and hit API to store in qalarsmm database.
     * @return  dashbaord page view blade with all data required to display from controller to view.
     */
    ...
    /**
     * TODO we've to add Linked in accounts from dashboard page to qalarsmm and display.
     * This function is adding Linked in accounts from front end and hit API to store in qalarsmm database.
     * @return  dashbaord page view blade with all data required to display from controller to view.
     */
    ...
    /**
     * TODO we've to add Facebook pages accounts from dashboard page to qalarsmm and display.
     * This function is adding Facebook pages  in accounts from front end and hit API to store in qalarsmm database.
     * @return  dashbaord page view blade with all data required to display from controller to view.
     */
    ...
    /**
     * TODO we've to add Youtube accounts from dashboard page to qalarsmm and display.
     * This function is adding Youtube Accounts  in accounts from front end and hit API to store in qalarsmm database.
     * @return  dashbaord page view blade with all data required to display from controller to view.
     */
        ...
        try {
            ...
            if ($response['data']->code === 200) {
                ...
                $data = array('account_type' => "9", 'user_name' => $channelId, 'first_name' => $channelname, 'email' => '', 'social_id' => $channelId,
                    'profile_pic_url' => $channelImageUrl, 'cover_pic_url' => 'https://www.qalarsmm.com/contents/qalarsmm/images/qalarsmm.png',
     ...
     * This function is used for updating star rating of the social Accounts  in accounts from front end and hit API to store in qalarsmm database.
     ...
     * This function is updating the star Crons of social Accounts  in accounts from front end and hit API to store in qalarsmm database.
    ...
    function addYoutubeCallbackInvite(Request $request)
    {
        ...
        try {
            ...
            if ($response['code'] === 200) {
                ...
                $refreshToken = $channelDetails['refreshToken'];
                $dataToPass = [];
                $data = array('account_type' => "9", 'user_name' => $channelId, 'first_name' => $channelname, 'email' => 'qalarsmm@qalarsmm.com', 'social_id' => $channelId,
                    'profile_pic_url' => $channelImageUrl, 'cover_pic_url' => 'https://www.qalarsmm.com/contents/qalarsmm/images/qalarsmm.png',
                    'last_name' => '', 'profile_url' => $channelProfileUrl, 'access_token' => $accessToken, 'refresh_token' => $refreshToken, 'friendship_counts' => $friendShipCount,
                    'info' => 'Build the success life with using Smart utils like sociobord for Social Networks'
                );
