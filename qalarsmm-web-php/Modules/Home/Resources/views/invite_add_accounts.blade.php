...
<head>
    ...
    <meta name="author" content="qalarsmm Technologies">
    ...
    <div class="card invitation-instruction">
        <div class="logo">
            ...
            <a href="index.html" class="mr-2">
                <img alt="qalarsmm" src="/media/logos/sb-icon.svg" class="mt-10">
            </a>
            <!--end::Logo-->
        </div>
        ...
        <div class="p-10">
            <p>Welcome to qalarsmm</p>
            <p>qalarsmm takes a step towards enhancing social media based measures for seamles Interaction. we add social accounts to the Respected Account Holder.</p>
            <p>qalarsmm request you to authorize and add your account with username started below to our flatform and allow access of account details to the respective User.</p>
