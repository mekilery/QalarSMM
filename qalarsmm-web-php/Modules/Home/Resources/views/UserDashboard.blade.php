...
@section('content')
    ...
    <script>
        ...
        if (window.getCookie('SBPlan')) {
            document.cookie = 'SBPlan=; Path=/;path=/;domain=qalarsmm.com; Expires=Thu, 01 Jan 1970 00:00:01 GMT;';
            window.location.href = "https://appv5.qalarsmm.com/amember/member";
        }
                                                    ...
                                                    <div class="tab-content mt-5"
                                                        ...
                                                        <div class="tab-pane fade show active"
                                                            ...
                                                            <div class="mt-8 mb-5"><label class="checkbox checkbox-lg mb-2 add-account-label">
                                                                    ...
                                                                    <span></span>
                                                                    <div class="font-size-lg font-weight-bold ml-4">qalarsmm needs permission to access and publish content to Facebook on your behalf. To grant permission, you must be an admin for your brand’s Facebook page.</div>
                                                                </label>
                                                            </div>
                                                    ...
                                                    <img src="{{session()->get('pages')[$i]->profilePicture}}"
                                                        ...
                                                        <div class="tab-pane fade"
                                                            ...
                                                            <div class="show_tw_divs" style="display: none;">
                                                                ...
                                                                <label class="checkbox mb-0 pt-5">
                                                                    ...
                                                                    Follow qalarsmm on twitter for update
                                                                    & announcements
                                                                </label>
                                                            </div>
                                                        </div>
                                                        <div class="tab-pane fade"
                                                            ...
                                                            <div class="mt-8 mb-5"><label class="checkbox checkbox-lg mb-2 add-account-label">
                                                                    ...
                                                                    <span></span>
                                                                    <div class="font-size-lg font-weight-bold ml-4">To allow qalarsmm access to your Instagram account, you
                                                        ...
                                                        <div class="tab-pane fade"
                                                             ...
                                                             aria-labelledby="youtube-tab-accounts">
                                                                ...
                                                                <div class="mt-8 mb-5"><label class="checkbox checkbox-lg mb-2 add-account-label">
                                                                        ...
                                                                        <span></span>
                                                                        <div class="font-size-lg font-weight-bold ml-4">To allow qalarsmm access to your
                                                                            Youtube account, you
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        ...
                        <a onclick="setTheCookie('reviewCoolie', userID,365);" aria-label="Close" href="https://appsumo.com/products/qalarsmm/#reviews" target="_blank" class="btn font-weight-bolder font-size-h6 px-4 py-4 mr-3 my-3">Review us on AppSumo</a>
                    </div>
                </div>
            </div>
        </div>
