...
<head>
    ...
    <!-- Hotjar Tracking Code for https://appv5.qalarsmm.com/login -->
    <script>
...
<div id="Sb_header_mobile" class="header-mobile header-mobile-fixed ">
    ...
    <a onclick="planCheck('{{env('APP_URL')}}dashboard')">
        <img alt="qalarsmm" src="{{asset('media/logos/sb-icon.svg')}}" style="width: 50px;" class="max-h-30px mt-5"/>
    </a>
    <!--end::Logo-->
                    ...
                    <div class=" container-fluid ">
                        ...
                        <div class="d-none d-lg-flex align-items-center mr-3">
                            ...
                            <a class="mr-2" onclick="planCheck({{env('APP_URL')}}dashboard)">
                                <img alt="qalarsmm" src="{{asset('media/logos/sb-icon.svg')}}" style="width: 50px;"
                    ...
                    <div class="card card-custom">
                        ...
                        <div class="card-header align-items-center px-4 py-3">
                            ...
                            <div class="text-center flex-grow-1">
                                <div class="font-weight-bold font-size-h5">qalarsmm <span
