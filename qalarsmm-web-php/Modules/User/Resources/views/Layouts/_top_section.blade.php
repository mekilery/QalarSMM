...
<div id="Sb_header_mobile" class="header-mobile header-mobile-fixed " >
    <!--begin::Logo-->
    <a href="index.html">
        <img alt="qalarsmm" src="/media/logos/sb-icon.svg" style="width: 50px;" class="max-h-30px mt-5"/>
    </a>
    <!--end::Logo-->
                    ...
                    <div class=" container-fluid ">
                        ...
                        <div class="d-none d-lg-flex align-items-center mr-3">
                            ...
                            <a href="index.html" class="mr-2">
                                <img alt="qalarsmm" src="/media/logos/sb-icon.svg" style="width: 50px;" class="max-h-35px mt-5"/>
                            </a>
                            <!--end::Logo-->
                ...
                <div class="navi mt-2">
                    <a href="#" class="navi-item">
                            <span class="navi-link p-0 pb-2">
                                ...
                                <span class="navi-text text-hover-primary">chanchalsantra@qalarsmm.com</span>
                            </span>
                    </a>
            ...
            <div class="card card-custom">
                ...
                <div class="card-header align-items-center px-4 py-3">
                    ...
                    <div class="text-center flex-grow-1">
                        <div class="font-weight-bold font-size-h5">qalarsmm <span class="text-mute">team</span></div>
                        <div>
